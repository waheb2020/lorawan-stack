...
class ConfigurationStep {
  ...
  selectLorawanVersion(version) {
    cy.findByLabelText('LoRaWAN version')
      .should('be.visible')
      .type(`${version}{enter}`, {
        force: true,
      })
...
class NetworkLayerStep {
  selectFrequencyPlan(plan) {
    cy.findByLabelText('Frequency plan')
      .should('be.visible')
      .type(`${plan}{enter}`, {
        force: true,
      })
  ...
  selectPhyVersion(version) {
    cy.findByLabelText('Regional Parameters version')
      .should('be.visible')
      .type(`${version}{enter}`, {
        force: true,
      })
  ...
  checkClassA() {
    cy.findByLabelText('Supports class A')
      .should('be.visible')
      .check()
  }
  ...
  selectPingSlotPeriodicity(periodicity) {
    cy.findByLabelText('Ping Slot Periodicity')
      .should('be.visible')
      .type(`${periodicity}{enter}`)
  }
